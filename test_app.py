...
import pytest
from app import app, get_temperature, get_temperature_status
...
def test_temperature_status_too_cold():
    ...
    assert get_temperature_status(5.0) == "Too Cold"
    assert get_temperature_status(9.9) == "Too Cold"


def test_temperature_status_good():
    """Test status is Good between 10 and 36."""
    assert get_temperature_status(10.0) == "Good"
    assert get_temperature_status(25.0) == "Good"
    assert get_temperature_status(36.0) == "Good"


def test_temperature_status_too_hot():
    """Test status is Too Hot above 36."""
    assert get_temperature_status(37.0) == "Too Hot"
    assert get_temperature_status(50.0) == "Too Hot"
